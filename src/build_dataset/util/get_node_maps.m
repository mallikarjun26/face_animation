...
function [facemap] = get_node_maps(output_path)

    map_file_name = [output_path '/intermediate_results/facemap.mat'];
    ...
    for i=1:number_of_faces
        facemap{i} = [faces_folder_name file_name_cell{i}];
    end
    
    save(map_file_name, 'facemap');
