function tests(dataset)
    ...
    save_fig_files(fail_rate, mean_err, mean_err_parts, ['~/data/results/iccv/' dataset '/basic_algorithm/']);
    close all;
    ...
    save_fig_files_comp(wo_met, w_met, ['~/data/results/iccv/' dataset '/wo_metric_vs_w_metric/']);
    close all;
    ...
    save_fig_files_comp(w_hog, w_sift, ['~/data/results/iccv/' dataset '/hog_vs_sift/']);
    close all;
    ...
    save_fig_files_comp(w_shape_kmeans, w_shape_pca, ['~/data/results/iccv/' dataset '/shape_kmeans_vs_shape_pca/']);
    close all;
    ...
    save_fig_files_comp(w_app_kmeans, w_app_pca, ['~/data/results/iccv/' dataset '/app_kmeans_vs_app_pca/']);
    close all;
    ...
    save_fig_files_comp(w_kmeans_shape, w_kmeans_app, ['~/data/results/iccv/' dataset '/kmeans_shape_vs_kmeans_app/']);
    close all;
    ...
    save_fig_files_9_bars(exem_10, exem_15, exem_20, exem_25, exem_30, ['~/data/results/iccv/' dataset '/num_of_exemplars/']);
    close all;
    ...
    close all;
    save_fig_files_9_bars(kNN_1, kNN_2, kNN_3, kNN_4, kNN_5, ['~/data/results/iccv/' dataset '/k_in_knn/']);
    close all;
