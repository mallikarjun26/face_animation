...
save_fig_files(fail_rate, mean_err, mean_err_parts, '~/data/results/iccv/cofw/basic_algorithm/');
...
save_fig_files_comp(wo_met, w_met, '~/data/results/iccv/cofw/wo_metric_vs_w_metric/');
...
save_fig_files_comp(w_hog, w_sift, '~/data/results/iccv/cofw/hog_vs_sift/');
...
save_fig_files_comp(w_shape_kmeans, w_shape_pca, '~/data/results/iccv/cofw/shape_kmeans_vs_shape_pca/');
...
save_fig_files_comp(w_app_kmeans, w_app_pca, '~/data/results/iccv/cofw/app_kmeans_vs_app_pca/');
...
save_fig_files_comp(w_kmeans_shape, w_kmeans_app, '~/data/results/iccv/cofw/kmeans_shape_vs_kmeans_app/');
...
save_fig_files_9_bars(exem_10, exem_15, exem_20, exem_25, exem_30, '~/data/results/iccv/cofw/num_of_exemplars/');
...
close all;
save_fig_files_9_bars(kNN_1, kNN_2, kNN_3, kNN_4, kNN_5, '~/data/results/iccv/cofw/k_in_knn/');
