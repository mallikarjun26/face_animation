...
[L,~] = lmnn2(xTr, yTr,3,L0,'maxiter',1000,'quiet',1,'outdim',6,'mu',0.5,'validation',0.2,'earlystopping',25,'subsample',0.3);
...
embed=gb_lmnn(xTr,yTr,6,L,'ntrees',200,'verbose',false,'XVAL',xVa,'YVAL',yVa);
