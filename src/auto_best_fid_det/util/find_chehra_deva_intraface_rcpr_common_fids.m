function find_chehra_deva_intraface_rcpr_common_fids(path)
    ...
    chehra_deva_intraface_rcpr_common_fids = zeros(size(common_lfpw,1),4);
    ...
    for i=1:size(common_lfpw,1)
        ...
        chehra_deva_intraface_rcpr_common_fids(i,:) = [chehra_lfpw{1,1}(ind_c,1) deva_lfpw{1,1}(ind_d,1) intraface_lfpw{1,1}(ind_i,1) rcpr_lfpw{1,1}(ind_r,1)];
