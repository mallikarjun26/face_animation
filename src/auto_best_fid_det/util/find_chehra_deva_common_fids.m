function find_chehra_deva_common_fids(path)
    ...
    chehra_deva_common_fids = zeros(size(common_lfpw,1),2);
    ...
    for i=1:size(common_lfpw,1)
        ...
        chehra_deva_common_fids(i,:) = [chehra_lfpw{1,1}(ind_c,1) deva_lfpw{1,1}(ind_d,1)];
        
    end
    
    save([path '/common_data/fids_mapping/chehra_deva_common_fids.mat'], 'chehra_deva_common_fids');
